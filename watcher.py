# Made by: Jorge Navarro
# Source: #https://medium.com/@jnavarr56/use-file-watching-and-subprocesses-to-develop-python-scripts-with-live-reloading-9ffaa66fd648
# --------------------------------------------------------------------------------
# Added & modified by: Aleksandr Molchagin
# Purpose: This script watches for changes in the bot's code and restarts the bot when changes are detected.
# Date: 03/23/2023
...
class Runner:
    ...
    def run():
        ...
        Runner.__proc = Popen(["python", './bot/bot.py'])
...
# exluding this one.
file_modified_event_handler = PatternMatchingEventHandler(patterns=["./*.py"], ignore_patterns=["./watcher.py"])
